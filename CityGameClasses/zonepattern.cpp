...
ZonePattern::
	GenerateBaseImage(u32 fgc,u32 bgc,u32 txtc)
		...
		u16 il=tl*ypixelsPerTile+amtfloors*zpixelsPerFloor;
		...
		//draw vertical wall
		short walltop=bbtm-padsz-amtfloors*zpixelsPerFloor;
